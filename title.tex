...
\begin{titlepage} % Suppresses displaying the page number on the title page and the subsequent page counts as page 1
    ...
    {\huge\bfseries Exerc\'icios de Aprendizado de M\'aquina}\\[4\baselineskip] % Title
	  %{\Huge\bfseries Exercises in \\[0.5\baselineskip]Machine Learning}\\[2\baselineskip] % Title
		...
		{\Large \bfseries Michael U. Gutmann \small \\ \textit{Traduzido o Organizado com auxílio} \\ \textit{do Gemini por Jacson R. Correia-Silva}}\\[\baselineskip]
